...
class ModeloEvaluacionController extends Controller
{
    public function index()
    {
        ...
        return view('dashboard.modelo_evaluacion.index', compact('modelos'));
    }

    public function create()
    {
        $programas = Programa::all();
        return view('dashboard.modelo_evaluacion.create', compact('programas'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('modelo_evaluacion.index')
    ...
    public function show($id)
    {
        ...
        return view('dashboard.modelo_evaluacion.show', compact('modeloEvaluacion'));
    }

    public function edit(ModeloEvaluacion $modeloEvaluacion)
    {
        $programas = Programa::all();
        return view('dashboard.modelo_evaluacion.edit', compact('modeloEvaluacion', 'programas'));
    }
